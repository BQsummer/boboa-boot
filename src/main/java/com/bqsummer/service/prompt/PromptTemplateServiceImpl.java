...
public class PromptTemplateServiceImpl implements PromptTemplateService {
    ...
    @Override
    @Transactional
    public PromptTemplateResponse create(PromptTemplateCreateRequest request, String createdBy) {
        // 参数校验
    ...
    @Override
    @Transactional
    public PromptTemplateResponse update(Long id, PromptTemplateUpdateRequest request, String updatedBy) {
        PromptTemplate template = promptTemplateMapper.selectById(id);
